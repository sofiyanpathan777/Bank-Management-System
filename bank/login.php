...
<head>
    ...
    define('bankName', 'Money Leaf Bank',true);
...
<body style="background: url(images/bg-login3.png);background-size: 100%">
<h1 class="alert alert-success rounded-0"><img src="images\logo8.png" width="60" height="50" class="d-inline-block align-top" alt="">&nbsp;<?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by: Sofiyan Pathan</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="yourmail1@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="pass1" class="form-control" required placeholder="Enter Password">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
         <form method="POST">
       	<input type="email" value="manager@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
